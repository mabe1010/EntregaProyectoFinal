    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="login.jsp">Iniciar Sesion <span class="sr-only">(current)</span></a>
      </li>
        <li class="nav-item dropdown">
...
<section class="formulariopet">
            <h5>Ingreso al Sistema</h5>
            <form action="checkuser" method="post">
            <input class="petcasilla" type="email" name="correo" id="correo" placeholder="Ingresa tu correo electronico" required>
            <input class="petcasilla" type="password" name="contrase" id="contrase" placeholder="Ingresa tu contraseña" required>
            <input id="submit" class="registropet" type="submit" value="Ingresar">
            <br>
            <br>
        </form>
        </section>
