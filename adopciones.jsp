  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0">
      ...
      <button class="btn btn btn-info my-2 my-sm-0" type="submit">Buscar</button>
        ...
        <p>Adoptar es un gran paso. Por eso en Mushu Pet queremos ayudarte para que ésta sea una de las mejores experiencias
            en tu vida y la de tu próximo amigo de cuatro patas.</p>
        <p>Ante todo, debes tener en cuenta la gran responsabilidad que representa tener un compañero cuatro patas dentro de tu vida</p>
        ...
        <ul>
            <li>Ser mayor de 21 años (llevar DNI)</li>
        ...
        <p>Una vez que nos indiques tu próximo amigo de cuatros patas a adoptar, evaluaremos si tu perfil coincide con el de la mascota y te detallamos los requisitos.</p>
       ...
       <div class="carousel">
            ...
            <br>
            <h6>Para mayor información pueden escribir a adoptar@mushupet.com.ar </h6>
            <br>
